...
{
	/// <inheritdoc />
	public partial class AddSubjectRepoTable : Migration
	{
		/// <inheritdoc />
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					MailAddres = table.Column<int>(type: "int", nullable: false),
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					table.PrimaryKey("PK_SubjectRepos", x => x.Id);
				});
			...
			migrationBuilder.InsertData(
				...
				values: new object[] { 1, new DateTime(2024, 5, 18, 17, 39, 14, 369, DateTimeKind.Local).AddTicks(2732), "2362", "Muhendislik ve mimarlik", 0, "w31312", "Galip", "1234567890", "1234567890", "1234567890", "1234567890", 0, "1234567890", "1234567890", "Abay", "2637239385", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
		}
